...
$sql = ""
        ...
        . "where p.min_autorizacao = 1 AND p.alu_organizacao not like '".$_SESSION["matricula"]."' group by p.min_id "
...
$sqlcountregs = "Select count(q.min_id) as qtdregs "
        ...
        . "from tb_Minicurso as p left join tb_Min_Alu_Participar as t on (p.min_id = t.min_id) where p.min_autorizacao = 1 AND p.alu_organizacao not like '".$_SESSION["matricula"]."' "
...
if (isset($_REQUEST["btn_buscar"])) {
    if ($_REQUEST["btn_buscar"]) {
        ...
        $sql = "select p.min_id as min_id, p.min_autorizacao as min_autorizacao, p.alu_organizacao as min_organizacao, p.min_nome as min_nome, "
                ...
                . "min_professor like '%" . $_REQUEST["campo_busca"] . "%' AND p.min_autorizacao = 1 AND p.alu_organizacao not like '".$_SESSION["matricula"]."' "
                . "order by p.min_id DESC LIMIT $idpag,$quantidadelinhas";
        $sqlcountregs = "Select count(q.min_id) as qtdregs "
                ...
                . "where min_" . $_REQUEST["busca"] . " like '%" . $_REQUEST["campo_busca"] . "%' OR "
                . "alu_nome like '%" . $_REQUEST["campo_busca"] . "%' and p.min_autorizacao = 1 AND p.alu_organizacao not like '".$_SESSION["matricula"]."' "
...
<html>
    ...
    <body>
        ...
        <div id='page-container'>
            ...
            <div id='content'>
                <div id="title">Minicursos Disponíveis</div>
                <div id="properties">
                    <?php
