...
<html>
    ...
    <body>
        ...
        <div id='page-container'>
            ...
            <div id='content'>
                <div id="title">Minhas Palestras</div>
                <div id="properties">
                    <?php
                ...
                <form id='search' class="one-line" method='get' action="/Palestras">
                    <div class="input">
                ...
                <table class="list">
                    <tr>
                        ...
                        <tr>
                            <td colspan="5">
                                Você ainda não ofertou Palestras.
                            </td>
                        </tr>
                        <?php
                    }
