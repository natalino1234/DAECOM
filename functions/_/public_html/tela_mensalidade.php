<script>
	$(document).ready(function(e){
    	...
    	$('.delete-mensalidade').click(function (e){
    	   var object = $(this);
    	   pid = object.attr('data-id');
    	   e.preventDefault();
           e.stopImmediatePropagation();
    	   $('#modalMensalidade').modal('open');
    	   
    	       
    	});
    	$('#btnSimMensalidade').click(function (e){
    	   window.location.href='index.php?tela=mensalidade&exc='+pid
    	});
...
<div class="section no-pad-bot" id="index-banner">
	...
	<div id="modalMensalidade" class="modal">
    <div class="modal-content">
      <h4>Deseja continuar?</h4>
    </div>
    <div class="modal-footer">
      <a href="javascript:void(0)" id="btnSimMensalidade" class="modal-action modal-close waves-effect waves-green btn-flat">Sim</a>
	...
	<?php 
		...
		if (isset($_REQUEST["pagar"])) {
            ...
            $vlMensalidade =  str_replace(",",".",str_replace(".","", $_POST["Valor"])) *1.0 ;
			...
			echo '<script>Materialize.toast("Pagamento realizado com sucesso!", 4000)</script>';
			}catch(PDOException $exception){
                if($exception->getCode() == 23000){
                    echo "<script>Materialize.toast('Pagamento já realizado para essa data', 4000)</script>";
                }else{
                    echo "<pre>";
	...
	<td><a class='delete-mensalidade' href='javascript:void(0)' data-id='".$sqlretorno3["cdMensalidade"]."'>Excluir</a> </td>
					    </tr> ";
