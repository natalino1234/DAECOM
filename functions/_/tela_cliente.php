...
<?php
    ...
    if (isset($_REQUEST["btnSalvar"])) {
            ...
            echo "Insira todos os dados antes de continuar";
        }
    }
?>
      ...
      <div class="row">
          <form id="formCrud" action="index.php?tela=cliente" method="POST" class="col s12">
              ...
              <div class="row">
                  ...
                  <p><input type="radio" value ="2" <?php echo ($_REQUEST["tipoCliente"] == "" || $_REQUEST["tipoCliente"] == "2")?"checked":"";  ?> name="tipoCliente"><label for="">Cliente</label></p>
                  <p><input type="radio" value ="1" <?php echo ($_REQUEST["tipoCliente"] == "1")?"checked":"";  ?> name="tipoCliente"><label for="">Administrador</label></p>
              </div>
