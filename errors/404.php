...
<html>
    ...
    <body>
        ...
        <div id='page-container'>
            ...
            <div id="content">
                <div id="title">Erro 404</div>
                <h2 style="width: 700px; border: none; text-align: center; margin-left: auto; margin-right: auto;">Não sei o que você estava procurando...<br>Mas nós também não encontramos. :(</h2>
                <img src="/errors/404.png" style="margin-left: auto; margin-right: auto; opacity: 0.7;" width="300">
            </div>
    </body>
</html>