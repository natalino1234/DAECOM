...
<html>
    ...
    <body>
        ...
        <div id='page-container'>
            ...
            <div id="content">
                <div id="title">Erro 500</div>
                <h2 style="width: 700px; border: none; text-align: center; margin-left: auto; margin-right: auto;">
                    Nossos servidores estão brigando,<br>
                    e não puderam atender seu pedido. :(
                </h2>
                <img src="/errors/500.png" style="margin-left: auto; margin-right: auto; opacity: 0.7;" width="500">
            </div>
    </body>
</html>