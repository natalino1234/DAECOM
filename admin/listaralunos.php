...
$exibeAlerta = false;
$sql = "select alu_matricula, alu_nome, alu_status, alu_email from tb_Aluno order by alu_nome LIMIT $idpag,$quantidadelinhas";
            ...
            $(document).ready(function () {
                $(document).on("click", ".colAcao a", function () {
                    ...
                    if (acao === "block") {
                        ...
                        executarAJAX($(this), "/functions/alunos/alterardados.php?funct=" + acao, {"matricula": mat}, "Aluno Desbloqueado.", "", undefined, function (element) {
                            var tr = element.parent().parent();
